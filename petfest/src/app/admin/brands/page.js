        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="logo" className="block text-sm font-medium text-black mb-1">Brand Logo (PNG only)</label>
                <input
                  id="logo"
                  type="file"
                  ref={fileInputRef}
                  ...
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-300 focus:border-blue-500 text-black"
                />
                <p className="mt-1 text-sm text-black">Please upload a PNG image file</p>
              </div>
            </div>
