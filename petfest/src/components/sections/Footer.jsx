    ...
    <footer className="bg-white min-h-screen w-full relative flex flex-col">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-10 xl:pt-12 flex-grow flex flex-col items-center">
        ...
        <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6" style={headerStyle}>
          <h1 className="font-crunch-chips text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl py-1 sm:py-1.5 md:py-2 lg:py-2.5 text-[#3F1508] text-center tracking-wider">
            SPONSORED
          </h1>
        </div>

        {/* OFFICIAL BANK PARTNER */}
        <div className="mb-8 sm:mb-10 md:mb-12 lg:mb-14" style={headerStyle}>
          <h1 className="font-crunch-chips text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl py-1 sm:py-1.5 md:py-2 lg:py-2.5 text-[#3F1508] text-center tracking-wider">
            OFFICIAL BANK PARTNER
          </h1>
        </div>
        ...
        <div className="w-full max-w-[200px] sm:max-w-[250px] md:max-w-[320px] lg:max-w-[400px] xl:max-w-[480px] 2xl:max-w-[550px] mb-8 sm:mb-10 md:mb-12 lg:mb-16 xl:mb-20">
