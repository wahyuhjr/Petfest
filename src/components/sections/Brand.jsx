          ...
          >
            ...
            {currentBrands.map((brand) => (
              <div key={brand.id} className="flex justify-center">
                ...
                >
                  <div className="w-[160px] h-[160px] sm:w-[200px] sm:h-[200px] md:w-full md:h-auto md:aspect-square relative bg-white rounded-full p-1 sm:p-2 border-2 border-gray-200 shadow-md hover:shadow-lg transition-all hover:scale-105 overflow-hidden">
                    <div className="absolute inset-0 rounded-full overflow-hidden">
                      <div className="absolute inset-0 p-4 sm:p-6 md:p-9 flex items-center justify-center">
                ...
                {Array.from({ length: totalPages }).map((_, index) => (
                  <div
                    ...
                    className={`h-3 w-3 rounded-full ${
                      currentPage === index ? "bg-white" : "bg-gray-300"
                    }`}
                  />
                ))}
              </div>
