        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">Animal Name</label>
                <input
                  id="name"
                  type="text"
                  value={formData.name}
              ...
              <div>
                <label htmlFor="image" className="block text-sm font-medium text-gray-700 mb-1">Animal Image (PNG only)</label>
                <input
                  id="image"
                  type="file"
                  ref={fileInputRef}
